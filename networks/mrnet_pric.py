...
class MRNet_PRIC(nn.Module):
    ...
    def forward(self, x, train=False):
        ...
        # print("x.shape: ", x.shape) # torch.Size([1152, 64, 20, 20])
        # print("input_features_low.shape: ", input_features_low.shape) # torch.Size([1152, 64, 20, 20])
        ...
        # print("2. x.shape: ", x.shape) # torch.Size([1152, 64, 20, 20])

...
class HCV_PRIC_V2(nn.Module):
    ...
    def forward(self, x, train=False):
        ...
        # print("1. x.shape", x.shape) # x.shape torch.Size([1152, 1, 80, 80])
        ...
        # print("2.1 x.shape", x.shape)
            # 2. x.shape torch.Size([576, 128, 5, 5])
            # 3. x.shape torch.Size([64, 4, 6, 128, 5, 5])
...
def hcv_pric_v2_analogy(**kwargs):
    return HCV_PRIC_V2(**kwargs, num_contexts=5, num_classes=4)